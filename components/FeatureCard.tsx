...
export function FeatureCard({ title, description, icon = "잎" }: FeatureCardProps) {
  return (
    <article className="soft-card hover-lift p-6">
      <div className="mb-5 grid h-12 w-12 place-items-center rounded-2xl bg-[#F5F8F1] text-sm font-bold text-[#1F5D2C]" aria-hidden="true">{icon}</div>
      <h3 className="text-lg font-bold text-[#173f22]">{title}</h3>
